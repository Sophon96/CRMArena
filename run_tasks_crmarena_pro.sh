...
for TASK_CATEGORY in "${TASKS[@]}"; do
    for AGENT_STRATEGY in "${STRATEGIES[@]}"; do
        ...
        echo "Running task: $TASK_CATEGORY with strategy: $AGENT_STRATEGY and model: $AGENT_MODEL and provider: $LLM_PROVIDER and interactive: $INTERACTIVE and privacy_aware_prompt: $PRIVACY_AWARE_PROMPT"
